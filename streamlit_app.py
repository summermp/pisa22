...
def home():
    ...
    test_items = [
    dict(title="",text="",interval=None,img="http://localhost:8501/app/static/img/banner/insight1.png",),
    dict(title="",text="",interval=2000,img="http://localhost:8501/app/static/img/banner/insight2.png",),
    dict(title="",text="",interval=2000,img="http://localhost:8501/app/static/img/banner/insight3.png",),
    dict(title="",text="",interval=2000,img="http://localhost:8501/app/static/img/banner/insight4.png",),
    dict(title="",text="",interval=2000,img="http://localhost:8501/app/static/img/banner/insight5.png",),
    dict(title="",text="",interval=None,img="http://localhost:8501/app/static/img/banner/insight6.png",),
    ]
...
def about():
    txt1 = tooltip('http://localhost:8501/app/static/img/students_talking.png', "<span style='boder: 1px solid blue; border-radius:4px; background-color:green; color: white; padding:2px;'><i class='fa-solid fa-child-reaching fa-fade'></i> 15-year-old students <i class='fa-solid fa-child-dress fa-fade'></i></span>")
    html("""
...
st.components.v1.html(
    ...
    decoration.style.backgroundImage = "url(http://localhost:8501/app/static/img/banner/merry_christmas.gif)";
